 ...
 */
class ilIliasEventBridgeReadEventTracker
{
    public const TABLE_NAME = 'evnt_evhk_ileb_read';
    ...
    /** @var ilIliasEventBridgeStatementFactory */
    private $statementFactory;

    /** @var ilIliasEventBridgeCourseContextResolver */
    private $courseContextResolver;

    /** @var ilIliasEventBridgeCourseTrackingRepository */
    ...
    public function __construct(
        ...
        ilIliasEventBridgeOutboxRepository $outboxRepository,
        ...
        $this->statementFactory = $statementFactory ?: new ilIliasEventBridgeStatementFactory($config);
        $this->courseContextResolver = $courseContextResolver ?: new ilIliasEventBridgeCourseContextResolver();
        $this->courseTrackingRepository = $courseTrackingRepository ?: new ilIliasEventBridgeCourseTrackingRepository();
        $this->denyLogRepository = $denyLogRepository ?: new ilIliasEventBridgeDenyLogRepository();
    }
