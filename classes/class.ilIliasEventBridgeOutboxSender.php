 ...
 */
class ilIliasEventBridgeOutboxSender
{
    ...
    public function __construct(ilIliasEventBridgeConfig $config, ilIliasEventBridgeOutboxRepository $outbox)
    {
        $this->config = $config;
        $this->outbox = $outbox;
    }
    ...
    public function sendBatch(): array
    {
        ...
        $client = new ilIliasEventBridgeTraxClient($this->config);
