 ...
 */
class ilIliasEventBridgeDenyLogRepository
{
    public const TABLE_NAME = 'evnt_evhk_ileb_dlog';
    ...
    {
        if (!class_exists('ilIliasEventBridgeConfig')) {
            return false;
        }

        try {
            return (new ilIliasEventBridgeConfig())->isDenyLogEnabled();
